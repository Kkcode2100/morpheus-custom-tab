...
class CustomTabInstanceTabProvider extends AbstractInstanceTabProvider {
	protected MorpheusContext morpheusContext
	protected Plugin plugin

	CustomTabInstanceTabProvider(Plugin plugin, MorpheusContext morpheusContext) {
